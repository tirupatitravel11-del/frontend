      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-6 py-16 lg:grid-cols-2 lg:py-24">
        ...
        <div>
          ...
          <p className="mt-5 max-w-xl text-base leading-7 text-slate-600">
            Speak directly to our human dispatchers for instant {from} to {to}{" "}
            bookings, custom multi-stop quotes, and 24/7 emergency support.
          </p>
          ...
          <ul className="mt-7 space-y-3 text-[15px] text-slate-700">
            {[
              ...
              `Custom quotes for outstation & multi-stop ${from}–${to} trips`,
