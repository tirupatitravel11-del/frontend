...
const AIRPORT_POINTS = [
  "Doorstep pickup, terminal drop — all terminals covered",
  "595-litre boot fits 3–4 large suitcases plus cabin bags",
...
export default function EtiosAirport({
  from = "Your City",
  to = "Destination",
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 sm:gap-14 sm:px-6 lg:grid-cols-2">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-4 max-w-xl text-sm leading-6 text-slate-600 sm:mt-5 sm:text-base sm:leading-7">
            ...
            {travelTime}. The Toyota Etios is our most booked airport cab —
            its massive 595-litre boot, powerful AC and bulletproof reliability
            make it the smartest choice for flyers.
          </p>
        ...
        <div className="w-full rounded-2xl border border-slate-200 bg-white p-5 shadow-xl sm:p-8">
          ...
          <div className="rounded-xl bg-gold/10 p-4 sm:p-5">
            <p className="text-sm leading-6 text-slate-700">
              ...
              10:00 AM (domestic)? Your Etios reaches your door at 6:45 AM for
              a 7:00 AM pickup.
            </p>
          </div>
          ...
          <div className="mt-5 flex items-start gap-3 text-sm leading-6 text-slate-600 sm:mt-6">
            ...
            <p>
              ...
              included in your fixed Etios fare.
            </p>
          </div>
        </div>
      </div>
