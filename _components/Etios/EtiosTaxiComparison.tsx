...
const ETIOS_POINTS = [
  ...
  "You're carrying 3–4 large suitcases — the Etios has a huge 595-litre boot",
  "You're heading for an airport transfer, business trip or outstation drive",
  "You want Toyota's legendary reliability and a smooth, rattle-free ride",
  "You want maximum luggage space at a budget-friendly fare",
];
...
const ALTERNATIVES = [
  {
    ...
    points: [
      ...
      "You prefer the most popular cab for city and airport rides",
    ],
  },
  {
    name: "Maruti Ertiga",
...
export default function EtiosTaxiComparison() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mx-auto mb-12 max-w-3xl text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-slate-900 md:text-4xl">
            Is an Etios the Right Choice for Your Trip?
          </h2>

          <p className="mt-4 text-base leading-7 text-slate-600">
            Check your purpose below — if it matches, the Etios is made for your
            trip. If not, we&apos;ll point you to the cab that fits better.
          </p>
        </div>
        ...
        <div className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-7 shadow-sm">
            <h3 className="text-xl font-bold text-slate-900">
              An Etios Fits Your Purpose If…
            </h3>

            <ul className="mt-6 space-y-4">
              {ETIOS_POINTS.map((point) => (
          ...
          <div className="flex flex-col rounded-xl bg-gold p-7 text-white shadow-lg">
            ...
            <h3 className="mt-2 text-2xl font-bold">
              Then the Etios Is Made for You.
            </h3>

            <p className="mt-4 text-sm leading-6 text-white/90">
              4 comfortable seats • 595-litre boot for 3–4 large bags • Toyota
              reliability — perfect for airport transfers, business travel and
              family trips.
            </p>
            ...
            <p className="mt-4 text-center text-xs text-white/80">
              Most travellers with heavy luggage choose the Etios for its unmatched boot space.
            </p>
          </div>
        </div>
