...
export default function FamilyLongDistanceSpotlightTaxi() {
  return (
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 sm:gap-14 sm:px-6 lg:grid-cols-2">
        ...
        <div className="min-w-0">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl md:text-4xl lg:leading-tight">
            Premium Long Distance Family Rides by{" "}
            <span className="text-gold">Innova Crysta</span>
          </h2>

          {/* Description */}
          <p className="mt-4 max-w-xl text-sm leading-6 text-slate-600 sm:mt-5 sm:text-base sm:leading-7">
            Planning a family trip, wedding travel, or a long-distance journey?
            Travel in a spacious Toyota Innova Crysta with comfortable seating,
            powerful AC, and plenty of luggage space for a smooth, safe, and
            relaxed ride.
          </p>
        ...
        <div className="w-full rounded-2xl border border-slate-200 bg-white p-5 shadow-xl sm:p-8">
          ...
          <div className="rounded-xl bg-gold/10 p-4 sm:p-5">
            <p className="text-sm leading-6 text-slate-700">
              ...
              Enough seating and luggage space for a comfortable family journey
              without having to take multiple cars.
            </p>
          </div>
          ...
          <div className="mt-5 flex items-start gap-3 text-sm leading-6 text-slate-600 sm:mt-6">
            ...
            <p>
              ...
              for family vacations, weddings, airport transfers and outstation
              trips.
            </p>
          </div>
        </div>
