import VehicleCard from "@/app/components/Cab/Cabhub/VehicleCard";
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-16 grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          {taxiFleet.map((vehicle) => (
            // Pass linkPrefix="/taxi/" to route to taxi detail pages
            <VehicleCard key={vehicle.id} {...vehicle} linkPrefix="/taxi/" />
          ))}
        </div>
      </div>
    </section>
