...
export default function AmazeTaxiFitGuide() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="mx-auto mb-10 max-w-3xl text-center sm:mb-12">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600 sm:text-base sm:leading-7">
            ...
            useful luggage space, and a smooth sedan experience for your local
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center rounded-2xl bg-gold p-5 text-white shadow-xl sm:p-7">
            ...
            <p className="mt-3 text-sm leading-6 text-white/90 sm:text-[15px]">
              ...
              practical combination of comfort and luggage space for any
              journey.
            </p>

            <a
              href={`tel:${PHONE_NUMBER}`}
              className="mt-5 inline-flex w-full items-center justify-center rounded-xl bg-white py-3.5 text-sm font-bold uppercase tracking-wide text-gold shadow-md transition-all duration-300 hover:bg-slate-100"
            >
              Book Honda Amaze →
            </a>
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gold/10 text-gold group-hover:bg-gold group-hover:text-white transition-colors duration-300">
                      <Icon size={22} />
                    </div>
                  ...
                  <a
                    href={`tel:${PHONE_NUMBER}`}
                    className="mt-5 inline-flex w-full items-center justify-center rounded-xl border border-gold py-3 text-sm font-bold uppercase tracking-wide text-gold transition-all duration-300 hover:bg-gold hover:text-white"
                  >
                    Book This Cab
                  </a>
                </div>
