...
const SEDAN_FITS = [
  ...
  "You're carrying 2–3 suitcases — perfect for airport drops or outstation trips",
...
interface SedanFitGuideTaxiProps {
  city?: string;
}

export default function SedanFitGuideTaxi({ city = "your city" }: SedanFitGuideTaxiProps) {
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="mx-auto mb-10 max-w-3xl text-center sm:mb-12">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl md:text-4xl">
            Is a Sedan Taxi the Right Choice for Your Trip in {city}?
          </h2>
        ...
        <div className="grid gap-5 lg:grid-cols-2 lg:gap-6">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
            <h3 className="text-lg font-bold text-slate-900 sm:text-xl">
              A Sedan Taxi Fits Your Purpose If…
            </h3>
          ...
          <div className="flex flex-col justify-center rounded-2xl bg-gold p-5 text-white shadow-xl sm:p-7">
            ...
            <h3 className="mt-2 text-xl font-bold leading-snug sm:text-2xl">
              Then the Sedan Taxi Is Made for You.
            </h3>
            ...
            <p className="mt-3 text-sm leading-6 text-white/90 sm:mt-4 sm:text-[15px] sm:leading-7">
              ...
              perfect balance of comfort and price for city and outstation travel.
            </p>
            ...
            <p className="mt-3 text-center text-xs text-white/80 sm:mt-4">
              Most riders choose the Sedan for comfortable travel.
            </p>
          </div>
        </div>
