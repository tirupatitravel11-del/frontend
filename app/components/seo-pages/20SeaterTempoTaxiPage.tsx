...
import TwentySeaterStorySection from "@/_components/20SeaterTempo/20SeaterDescription";
import TwentySeaterSeating from "@/_components/20SeaterTempo/TwentySeaterSeating";
import TwentySeaterFaq from "@/_components/20SeaterTempo/TwentySeaterFaq";
...
const FEATURES = [
  { icon: Users, label: "20+1 Seating", sub: "Spacious pusher seats" },
  { icon: Luggage, label: "Extra Luggage", sub: "Large boot capacity" },
...
export default function TwentySeaterTempoTravellerPage() {
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-6 py-16 lg:grid-cols-2 lg:py-24">
          ...
          <div>
            ...
            <h1 className="text-4xl font-bold tracking-tight text-slate-900 md:text-5xl lg:leading-tight">
              20 Seater Tempo Traveller on Rent for{" "}
              <span className="text-gold">Large Group Travel</span>
            </h1>

            <p className="mt-5 max-w-xl text-base leading-7 text-slate-600">
              The ideal choice for big families, wedding parties, corporate
              groups, and large pilgrimages. Our 20 Seater Tempo Traveller
              combines spacious seating, premium amenities like LED TV and music
              system, and extra luggage space — perfect for long journeys with a
              large group.
            </p>
            ...
            <ul className="mt-8 space-y-3 text-[15px] text-slate-700">
              {[
                "Perfect for large families, wedding parties, and big groups",
                "Premium amenities including LED TV and music system",
                "Extra luggage space for long trips and pilgrimages",
                "Experienced drivers for highway and outstation routes",
              ].map((point) => (
            ...
            <form onSubmit={handleWhatsAppSubmit} className="mt-5 space-y-4">
              ...
              <div className="rounded-xl bg-gold/10 p-4">
                <p className="text-sm text-slate-700">
                  ...
                  <strong className="text-gold">Selected:</strong> 20 Seater
                  Tempo Traveller —{" "}
