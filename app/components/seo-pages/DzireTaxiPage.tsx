...
// Dzire specific components (create these based on your existing components)
// import DzireFitGuide from "@/_components/Dzire/DzireFitGuide"; // Adapt from InnovaCrystaFitGuide
...
const DZIRE_MODELS = [
  ...
  "Maruti Suzuki Dzire ZXI (Top Model)",
];
          ...
          <div className="grid w-full items-center gap-12 lg:grid-cols-2">
            ...
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl font-bold leading-[1.1] tracking-tight text-slate-900 sm:text-5xl md:text-6xl">
                {page.title || "Maruti Suzuki Dzire Rental"}{" "}
                <span className="text-gold">at Fixed Fares</span>
              </h1>

              <p className="mt-6 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
                {page.description ||
                  "Travel smart with the Maruti Suzuki Dzire — India's most trusted sedan. Perfect for couples, small families, airport transfers, and budget-friendly outstation trips with excellent mileage and smooth ride quality."}
              </p>
...
function DzireBookingForm() {
  ...
  const handleBook = (e: React.FormEvent) => {
    ...
    const message = `Hello, I want to book a Maruti Suzuki Dzire.
...
Please share the fare and availability.`;
  ...
  return (
    <div className="rounded-3xl border border-slate-200/60 bg-white p-6 shadow-2xl shadow-slate-200/50 sm:p-8">
      <div className="mb-6">
        <h3 className="text-2xl font-bold text-slate-900">Book Your Dzire</h3>
